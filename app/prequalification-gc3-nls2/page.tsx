...
import { PrequalificationGC3NLS2Wizard } from "@/components/prequalification-gc3-nls2-wizard"
import Image from "next/image"
import { useRouter } from "next/navigation"
import "./prequalification.css"

export default function PrequalificationGC3NLS2Page() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-2 max-w-3xl overflow-y-auto">
        <div className="mb-6">
          <h2 className="text-2xl font-semibold mb-2">Multiple Occupants Pre-Qualification</h2>
          <p className="text-gray-600">
            This pre-qualification process is for non-applicant occupants in a multi-occupant household. Please complete
            all steps to determine your eligibility.
          </p>
        </div>
        <PrequalificationGC3NLS2Wizard />
      </div>
